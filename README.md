...
本项目是一个[利用Travis-CI部署Docker到Heroku](https://github.com/362227/v2hero/tree/core-3.8) 的学习示例。

如果为您的学习提供了帮助，欢迎给一个Star ^_^

* 快捷部署
   [![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/362227/v2hero/tree/core-latest)
